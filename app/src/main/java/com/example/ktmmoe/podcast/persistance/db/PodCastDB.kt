...
import com.example.ktmmoe.podcast.persistance.daos.DownloadDao
 ...
 **/
@Database(entities = [PodCastResponse::class, Genre::class, PodCastWrapper::class, Download::class], version = 2, exportSchema = false)
